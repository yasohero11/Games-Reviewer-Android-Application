...
public class EditGameActivity extends AppCompatActivity implements IPickResult {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gameName.setText(GamesOld.modifiableGame.getName());
        gamePrice.setText(String.valueOf(GamesOld.modifiableGame.getPrice()));
        gameImage = findViewById(R.id.gameImage);
        System.out.println(GamesOld.modifiableGame.getImage());
        /*
